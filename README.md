...
- 🏗️ **헥사고날 아키텍처 · DDD · 이벤트 기반 MSA** 로 시스템의 경계를 설계합니다
...
- **[shopping-lowprice](https://github.com/MyoungSoo7/shopping-lowprice)** — 저가 쇼핑 (Spring Boot · JPA · Scheduler · Spring Security)
